...
bool Shader::Compile()
{
	...
	Timer compileTime = Timer();
	compileTime.Start();

	LogGraphics("Recompiling shader: "+name, INFO);
	...
	LogGraphics(name+ " Shader Compilation Successful! Time taken: "+ String(compileTime.GetMs())+" ms", INFO);
