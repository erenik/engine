...
The Decoder class stores information about the PNG image in an LodePNG_InfoPng Entity. With
the Encoder you can do the opposite: you give it an LodePNG_InfoPng Entity, and it'll try
