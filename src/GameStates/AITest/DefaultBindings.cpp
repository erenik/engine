...
//void AITest::CreateDefaultBindings(){
//	std::cout<<"\nAITest::CreateDefaultBindings() called";
//
//	/// Nullify the aiTestSelection.Size()
//	aiTestSelection.Clear();
//
//	/// (int action, int * inputCombinationArray, int inputs, const char * name = NULL);
//	/// Get pointer to this mapping
//	InputMapping * mapping = &Input.inputMapping[GAME_STATE_AI_TEST];
//	/// Create default bindings
//
//	/// C = Create, L = List
//
//	// Edit Simulation
//	mapping->CreateBinding(INCREASE_SPEED, KEY::CTRL, KEY::PLUS, "CTRL+PLUS : Increase simulation speed");
//	mapping->CreateBinding(DECREASE_SPEED, KEY::CTRL, KEY::MINUS, "CTRL+MINUS : Increase simulation speed");
//
//
...
//	/// Adjusting speeds
//	mapping->CreateBinding(INCREASE_CAMERA_SPEED, KEY::PLUS, "PLUS : Increase Speed"); mapping->Repeatable(true); mapping->SetBlockingKeys(KEY::CTRL);
//	mapping->CreateBinding(DECREASE_CAMERA_SPEED, KEY::MINUS, "MINUS : Decrease Speed"); mapping->Repeatable(true); mapping->SetBlockingKeys(KEY::CTRL);
//
//	/// Home- rest camera :D
